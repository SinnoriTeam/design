 ...
 *
 */
public class ItemValidatorOfJdbcDriverClassName extends ItemValidator {
	public ItemValidatorOfJdbcDriverClassName(String defaultValue) throws ConfigException {
		super(defaultValue);
	}
