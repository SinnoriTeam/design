 ...
 *
 */
public class ItemValueGetterOfMultiStringSet extends AbstractItemValueGetter {
	private Set<String> stringValueSet = new HashSet<String>();
	
	public ItemValueGetterOfMultiStringSet(String ... parmValueSet) throws ConfigValueInvalidException {		
