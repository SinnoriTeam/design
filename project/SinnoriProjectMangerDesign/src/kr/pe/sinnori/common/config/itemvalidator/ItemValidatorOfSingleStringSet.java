 ...
 *
 */
public class ItemValidatorOfSingleStringSet extends AbstractItemValidator {
	private Set<String> stringValueSet = new HashSet<String>();
	public ItemValidatorOfSingleStringSet(String ... parmValueSet) throws ConfigValueInvalidException {
