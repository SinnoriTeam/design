...
public class MinMaxLongDependenceBreaker extends AbstractDependenceBreaker {

	public MinMaxLongDependenceBreaker(
			String targetItemID, 			
	...
	public void validate(Properties sourceProperties, 
		...
		try {
			...
			if (!(valueObject instanceof Long)) {
				...
				.append("] is not a long type")
				.toString();
				log.warn(errorMessage);
				throw new ConfigValueInvalidException(errorMessage);
			}
			min = (Long)valueObject;
