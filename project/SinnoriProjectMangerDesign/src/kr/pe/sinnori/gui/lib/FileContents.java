...
public abstract class FileContents {
	private static Logger log = LoggerFactory.getLogger(FileContents.class);
	...
	public static String getServerAntBuildXMLFileContent(String mainProjectName, String serverExecutableJarShortFileName) {
		StringBuilder stringBuilder = new StringBuilder();
		...
		// stringBuilder.append("\t\t<jar destfile=\"${dist}/SinnoriServerRun.jar\" basedir=\"${build}\">");
